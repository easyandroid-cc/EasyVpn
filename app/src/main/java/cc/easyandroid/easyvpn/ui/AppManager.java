...
public class AppManager extends Activity{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.setContentView(cc.easyandroid.easyvpn.R.layout.layout_apps);

        ActionBar actionBar = getActionBar();
        if (actionBar != null)
            actionBar.setDisplayHomeAsUpEnabled(true);

        loadingView = findViewById(cc.easyandroid.easyvpn.R.id.loading);
        appListView = (RecyclerView)findViewById(cc.easyandroid.easyvpn.R.id.list);
        ...
        fastScroller = (FastScroller)findViewById(cc.easyandroid.easyvpn.R.id.fastscroller);
...
class AppViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    private ImageView icon = (ImageView)itemView.findViewById(cc.easyandroid.easyvpn.R.id.itemicon);
    private Switch check = (Switch)itemView.findViewById(cc.easyandroid.easyvpn.R.id.itemcheck);
...
class AppManagerAdapter extends RecyclerView.Adapter<AppViewHolder> implements SectionTitleProvider {
    ...
    public AppViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new AppViewHolder(LayoutInflater.from(parent.getContext()).inflate(cc.easyandroid.easyvpn.R.layout.layout_apps_item, parent, false));
    }
