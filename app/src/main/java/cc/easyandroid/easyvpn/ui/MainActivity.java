...
import cc.easyandroid.easyvpn.core.AppInfo;
...
public class MainActivity extends Activity implements View.OnClickListener, OnCheckedChangeListener, LocalVpnService.onStatusChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cc.easyandroid.easyvpn.R.layout.activity_main);

        scrollViewLog = (ScrollView) findViewById(cc.easyandroid.easyvpn.R.id.scrollViewLog);
        textViewLog = (TextView) findViewById(cc.easyandroid.easyvpn.R.id.textViewLog);
        findViewById(cc.easyandroid.easyvpn.R.id.ProxyUrlLayout).setOnClickListener(this);
        findViewById(cc.easyandroid.easyvpn.R.id.AppSelectLayout).setOnClickListener(this);

        textViewProxyUrl = (TextView) findViewById(cc.easyandroid.easyvpn.R.id.textViewProxyUrl);
        String ProxyUrl = readProxyUrl();
        if (TextUtils.isEmpty(ProxyUrl)) {
            textViewProxyUrl.setText(cc.easyandroid.easyvpn.R.string.config_not_set_value);
        } else {
        ...
        if (AppProxyManager.isLollipopOrAbove) {
            ...
            textViewProxyApp = (TextView) findViewById(cc.easyandroid.easyvpn.R.id.textViewAppSelectDetail);
        } else {
    ...
    public void onClick(View v) {
        ...
        if (v.getTag().toString().equals("ProxyUrl")) {
            new AlertDialog.Builder(this)
                    .setTitle(cc.easyandroid.easyvpn.R.string.config_url)
                    .setItems(new CharSequence[]{
                            getString(cc.easyandroid.easyvpn.R.string.config_url_scan),
                            getString(cc.easyandroid.easyvpn.R.string.config_url_manual)
                    }, new OnClickListener() {
                        @Override
    ...
    private void scanForProxyUrl() {
        new IntentIntegrator(this)
                ...
                .setPrompt(getString(cc.easyandroid.easyvpn.R.string.config_url_scan_hint))
    ...
    private void showProxyUrlInputDialog() {
        ...
        editText.setHint(getString(cc.easyandroid.easyvpn.R.string.config_url_hint));
        editText.setText(readProxyUrl());

        new AlertDialog.Builder(this)
                .setTitle(cc.easyandroid.easyvpn.R.string.config_url)
                .setView(editText)
                .setPositiveButton(cc.easyandroid.easyvpn.R.string.btn_ok, new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (isValidUrl(ProxyUrl)) {
                            ...
                            Toast.makeText(MainActivity.this, cc.easyandroid.easyvpn.R.string.err_invalid_url, Toast.LENGTH_SHORT).show();
                        }
                    }
                })
    ...
    private void startVPNService() {
        String ProxyUrl = readProxyUrl();
        if (!isValidUrl(ProxyUrl)) {
            Toast.makeText(this, cc.easyandroid.easyvpn.R.string.err_invalid_url, Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(cc.easyandroid.easyvpn.R.menu.main_activity_actions, menu);

        MenuItem menuItem = menu.findItem(cc.easyandroid.easyvpn.R.id.menu_item_switch);
        if (menuItem == null) {
            return false;
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case cc.easyandroid.easyvpn.R.id.menu_item_about:
                new AlertDialog.Builder(this)
                        .setTitle(getString(cc.easyandroid.easyvpn.R.string.app_name) + getVersionName())
                        .setMessage(cc.easyandroid.easyvpn.R.string.about_info)
                        .setPositiveButton(cc.easyandroid.easyvpn.R.string.btn_ok, null)
                        .setNegativeButton(cc.easyandroid.easyvpn.R.string.btn_more, new OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                ...
                return true;
            case cc.easyandroid.easyvpn.R.id.menu_item_exit:
                ...
                return true;
            case cc.easyandroid.easyvpn.R.id.menu_item_toggle_global:
